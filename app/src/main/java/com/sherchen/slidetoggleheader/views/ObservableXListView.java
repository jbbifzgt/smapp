...
package com.sherchen.slidetoggleheader.views;
 ...
 */
public class ObservableXListView extends XListView implements Scrollable {
    ...
    public ObservableXListView(Context context) {
        super(context);
        init();
    }

    public ObservableXListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ObservableXListView(Context context, AttributeSet attrs, int defStyle) {
